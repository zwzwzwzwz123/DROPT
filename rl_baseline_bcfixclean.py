...
# -*- coding: utf-8 -*-
"""
SAC baseline aligned with main_building_fno_guided_bcfix_clean.py.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="SAC baseline aligned with the bcfixclean environment."
    )
    ...
    parser.add_argument("--log-prefix", type=str, default="sac_baseline_bcfixclean")
...
def main():
    ...
    print("\n" + "=" * 70)
    print("  SAC Baseline Aligned With BCFixClean")
    print("=" * 70)
